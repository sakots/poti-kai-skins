...
//テンプレートのバージョン
define('TEMPLATE_VER', "lot.180124");
...
//メインのテンプレートファイル
define('MAINFILE', "n5r_main.html");

//レスのテンプレートファイル
define('RESFILE', "n5r_main.html");

//その他のテンプレートファイル
define('OTHERFILE', "n5r_other.html");

//お絵かきのテンプレートファイル
define('PAINTFILE', "n5r_paint.html");

//カタログのテンプレートファイル
define('CATALOGFILE', "n5r_catalog.html");
