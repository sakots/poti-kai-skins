<?php
/*
  * Template - nee - v3.0 lot.200413  by sakots  >> https://sakots.red/poti/
  *
  * potiboard.php(v1.55.4～)のTemplate設定ファイルです。
  *
*/

//テンプレートのバージョン
define('TEMPLATE_VER', "v3.0.1 lot.200524");
...
//メインのテンプレートファイル
define('MAINFILE', "nee_main.html");

//レスのテンプレートファイル
define('RESFILE', "nee_main.html");

//その他のテンプレートファイル
define('OTHERFILE', "nee_other.html");

//お絵かきのテンプレートファイル
define('PAINTFILE', "nee_paint.html");

//カタログのテンプレートファイル
define('CATALOGFILE', "nee_catalog.html");
...
define('ADMIN_DELKISU', '002222');

//管理画面(削除モード)の偶数行カラー　使わない
define('ADMIN_DELGUSU', '002200');
