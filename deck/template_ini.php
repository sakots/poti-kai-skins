<?php
/*
  * Template - deck - v1.00 lot.191026  by sakots  >> https://sakots.red/poti/
  *
...
//テンプレートのバージョン
define('TEMPLATE_VER', "v1.00 lot.191027");
...
//メインのテンプレートファイル
define('MAINFILE', "deck_main.html");

//レスのテンプレートファイル
define('RESFILE', "deck_main.html");

//その他のテンプレートファイル
define('OTHERFILE', "deck_other.html");

//お絵かきのテンプレートファイル
define('PAINTFILE', "deck_paint.html");

//カタログのテンプレートファイル
define('CATALOGFILE', "deck_catalog.html");
